...
while counter < 102:
    ...
    if msg == b'b':
        ...
        workbook = xlsxwriter.Workbook('%d.xlsx' %counter) 
        worksheet = workbook.add_worksheet()
        worksheet.write_column(0, 0, TR1r)
        worksheet.write_column(0, 1, TR1i)
        worksheet.write_column(0, 2, TR2r)
        worksheet.write_column(0, 3, TR2i)
        worksheet.write_column(0, 4, TR3r)
        worksheet.write_column(0, 5, TR3i)
        worksheet.write_column(0, 6, TR4r)
        worksheet.write_column(0, 7, TR4i)
        worksheet.write_column(0, 8, TR5r)
        worksheet.write_column(0, 9, TR5i)
        worksheet.write_column(0, 10, TR6r)
        worksheet.write_column(0, 11, TR6i)
        worksheet.write_column(0, 12, TR7r)
        worksheet.write_column(0, 13, TR7i)
        worksheet.write_column(0, 14, TR8r)
        worksheet.write_column(0, 15, TR8i)
        worksheet.write_column(0, 16, TR9r)
        worksheet.write_column(0, 17, TR9i)
        worksheet.write_column(0, 18, TR10r)
        worksheet.write_column(0, 19, TR10i)
        worksheet.write_column(0, 20, TR11r)
        worksheet.write_column(0, 21, TR11i)
        worksheet.write_column(0, 22, TR12r)
        worksheet.write_column(0, 23, TR12i)
        worksheet.write_column(0, 24, TR13r)
        worksheet.write_column(0, 25, TR13i)
        worksheet.write_column(0, 26, TR14r)
        worksheet.write_column(0, 27, TR14i)
        worksheet.write_column(0, 28, TR15r)
        worksheet.write_column(0, 29, TR15i)
        worksheet.write_column(0, 30, TR16r)
        worksheet.write_column(0, 31, TR16i)
        workbook.close()
